...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		ClientePJ cliente2 = new ClientePJ("Empresa1", "Av Albert Einstein", "12345678912345", new Date(), 200);
...
System.out.println("O cliente foi cadastrado com sucesso?");
		...
		Sinistro acidente1 = new Sinistro("01012023", "Avenida Zeferino Vaz", seguradora1, veiculo1, cliente1);
		 ...
		 seguradora1.listarClientes("PJ");
	        ...
	        System.out.println("O valor do seguro é:");
	            ...
	            switch (opcao) {
	                ...
	                case TRANSFERIR_SEGURO:
		                ...
		                if (tipoCliente.equals("PJ")) {
		                    ...
		                    cnpjCliente, new Date(), qtdeCliente);
